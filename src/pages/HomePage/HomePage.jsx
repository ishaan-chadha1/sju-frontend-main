...
const HomePage = () => {
  ...
  const handleFileUpload = async (file, type) => {
    ...
    formData.append("uploader", "Miyagi Labs");

    try {
      const response = await fetch(`http://localhost:4000/${type === "verify" ? "verify" : "upload"}`, {
        method: "POST",
        body: formData,
      });
          ...
          <li>
            ...
            <div className="box">
              <div className="box-content">
                ...
                <h5>Drag & Drop</h5>
                <input type="file" onChange={handleFileChangeVerify} />
              </div>
            </div>
          </li>
          <li>
                        ...
                        <div className="viewcontract musicbox-dropdown">
                          <label for="checkdropdown2">
                            ...
                            <ul className="tabledropdown trashfile bsyncfile homepage">
                              <li>
                                <Icon icon="mdi-light:music" /> Music
                              </li>
                              <li>
                              ...
                              <li className="bill">
                                <Icon icon="solar:bill-check-outline" /> Bills
                              </li>
                            </ul>
                          </label>
                        </div>
                ...
                <div className="checkbutton">
                  ...
                  <Link className="button1">
                    <div className="fileview">
                      <h3>
                        <Image src="Images/homepage/filerequest.svg"></Image>{" "}
                        File Requests
                      </h3>
                      <ul>
                        <li>
                ...
                <div className="checkbutton">
                  ...
                  <Link className="button2">
                    <div className="fileview bg-lightblue">
                      <h3>
                        <Image src="Images/homepage/bluetransfer.svg"></Image>{" "}
                        File Requests
                      </h3>
                      <ul>
                        <li>
